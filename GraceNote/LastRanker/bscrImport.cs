...
namespace HyoutaTools.GraceNote.LastRanker {
	class bscrImport {
		public static int Import( List<string> args ) {
			...
			InsertSQL( bscrFile, "Data Source=" + OutDatabase, "Data Source=" + GracesJapanese );

			return 0;
		}

		public static bool InsertSQL( HyoutaTools.LastRanker.bscr bscrFile, String ConnectionString, String ConnectionStringGracesJapanese ) {
