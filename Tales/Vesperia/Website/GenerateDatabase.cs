			...
			using ( var transaction = DB.BeginTransaction() ) {
				...
				using ( var commandSteal = DB.CreateCommand() ) {
					...
					foreach ( var item in Site.Items.items ) {
						...
						command.GetParameter( "htmlJ"  ).Value = ItemDat.ItemDat.GetItemDataAsHtml( Site.Version, Site.VersionPostfix, Site.Locale, WebsiteLanguage.Jp             , Site.Items, item, Site.Skills, Site.Enemies, Site.Recipes, Site.Locations, Site.Shops, Site.SearchPoints, Site.StringDic, Site.InGameIdDict, phpLinks: true );
						command.GetParameter( "htmlE"  ).Value = ItemDat.ItemDat.GetItemDataAsHtml( Site.Version, Site.VersionPostfix, Site.Locale, WebsiteLanguage.En             , Site.Items, item, Site.Skills, Site.Enemies, Site.Recipes, Site.Locations, Site.Shops, Site.SearchPoints, Site.StringDic, Site.InGameIdDict, phpLinks: true );
						command.GetParameter( "htmlCJ" ).Value = ItemDat.ItemDat.GetItemDataAsHtml( Site.Version, Site.VersionPostfix, Site.Locale, WebsiteLanguage.BothWithJpLinks, Site.Items, item, Site.Skills, Site.Enemies, Site.Recipes, Site.Locations, Site.Shops, Site.SearchPoints, Site.StringDic, Site.InGameIdDict, phpLinks: true );
						command.GetParameter( "htmlCE" ).Value = ItemDat.ItemDat.GetItemDataAsHtml( Site.Version, Site.VersionPostfix, Site.Locale, WebsiteLanguage.BothWithEnLinks, Site.Items, item, Site.Skills, Site.Enemies, Site.Recipes, Site.Locations, Site.Shops, Site.SearchPoints, Site.StringDic, Site.InGameIdDict, phpLinks: true );
