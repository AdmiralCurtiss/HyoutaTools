...
namespace HyoutaTools.Tales.Vesperia.To8chtx {
	...
	class ChatFile {
		...
		public ChatFile( byte[] TO8CHTX ) {
			...
			Header.Identify = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt64( TO8CHTX, 0x00 ) );
			Header.Filesize = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x08 ) );
			Header.Lines = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x0C ) );
			Header.Unknown = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x10 ) );
			Header.TextStart = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x14 ) );
			Header.Empty = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt64( TO8CHTX, 0x18 ) );
			...
			for ( int i = 0; i < Header.Lines; i++ ) {
				...
				Lines[i].Name = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x20 + i * 0x10 ) );
				Lines[i].JPN = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x24 + i * 0x10 ) );
				Lines[i].ENG = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x28 + i * 0x10 ) );
				Lines[i].Unknown = HyoutaTools.Util.SwapEndian( BitConverter.ToUInt32( TO8CHTX, 0x2C + i * 0x10 ) );

				Lines[i].SName = HyoutaTools.Util.GetTextShiftJis( TO8CHTX, (int)(Lines[i].Name + Header.TextStart) );
				Lines[i].SJPN = HyoutaTools.Util.GetTextShiftJis( TO8CHTX, (int)(Lines[i].JPN + Header.TextStart) );
				Lines[i].SENG = HyoutaTools.Util.GetTextShiftJis( TO8CHTX, (int)(Lines[i].ENG + Header.TextStart) ).Replace( '@', ' ' );
			}
		}
		...
		public byte[] Serialize() {
			...
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.Identify ) ) );
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.Filesize ) ) );
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.Lines ) ) );
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.Unknown ) ) );
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.TextStart ) ) );
			Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Header.Empty ) ) );

			foreach ( ChatFileLine Line in Lines ) {
				Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Line.Name ) ) );
				Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Line.ENG ) ) );
				Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Line.ENG ) ) );
				Serialized.AddRange( System.BitConverter.GetBytes( HyoutaTools.Util.SwapEndian( Line.Unknown ) ) );
			}
