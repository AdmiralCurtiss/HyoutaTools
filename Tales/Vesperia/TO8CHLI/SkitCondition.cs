...
namespace HyoutaTools.Tales.Vesperia.TO8CHLI {
	...
	public class SkitCondition {
		...
		public void GetDataAsHtml( StringBuilder sb, GameVersion version, WebsiteLanguage websiteLanguage, Dictionary<uint, TSS.TSSEntry> inGameIdDict ) {
			switch ( Type ) {
				...
				case SkitConditionType.CookingCharacterBitmask:
					...
					Website.WebsiteGenerator.AppendCharacterBitfieldAsImageString( sb, inGameIdDict, version, (uint)Value1, websiteLanguage.MainJp() );
