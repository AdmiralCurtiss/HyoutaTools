...
namespace HyoutaTools.Pokemon.Gen4 {
	public class String4 {
		...
		public String4( byte[] data ) {
			_RawData = data;
			_Text = GetStringGeneration4( data, 0, data.Length );
		}
		public String4( byte[] data, int location, int length ) {
			_Text = GetStringGeneration4( data, location, length );
			_RawData = new byte[length];
			Array.Copy( data, location, _RawData, 0, length );
		}
