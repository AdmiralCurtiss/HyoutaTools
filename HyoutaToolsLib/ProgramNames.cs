...
namespace HyoutaTools {
	...
	public class ProgramNames {
		...
		internal static List<KeyValuePair<ProgramName, ExecuteProgramDelegate>> BuiltInTools = new List<KeyValuePair<ProgramName, ExecuteProgramDelegate>>() {
			...
			{ new KeyValuePair<ProgramName, ExecuteProgramDelegate>( new ProgramName( "Tales.CPK.Decompress",                    "-"           ),  Tales.CPK.Program.Decompress) },
			{ new KeyValuePair<ProgramName, ExecuteProgramDelegate>( new ProgramName( "Tales.CPK.Compress",                      "-"           ),  Tales.CPK.Program.Compress) },
